        ...
        <jet-form-section :tbs="2" @submitted="createStore">
          ...
          <template #formContent1>
            ...
            <div class="col-span-6 sm:col-span-4">
              <jet-label for="Cuenta Milan" value=" Cuenta Milan" class="font-serif text-xl" />
              <hr />
              <br>
            </div>
            ...
            <div class="col-span-6 sm:col-span-4">
              <div class="md:w-2/5">
                ...
                <jet-input
                  ...
                  autocomplete="nit"
                />
                <jet-input-error :message="CreateTransferForm.errors.nit" class="mt-2" />
              </div>
            </div>
            <br>
            ...
            <div class="col-span-6 sm:col-span-4 md:flex" >
                      <div class="mt-3 md:mt-0 md:ml-0 md:w-3/5">
                        <jet-label for="id" value="El Maximo a consignar es de : " />{{ "$ " + formatMiles(1250000) }}
                      </div>
                           <div class="mt-3 md:mt-0 md:ml-2 md:w-3/5">
                      </div>
             <!-- Boton Solicitar Consignacion a Milan  -->
            <div class="mt-3 md:mt-0 md:ml-9 md:w-1/5">
             <jet-button>
              Solicitar
            </jet-button>
            </div>
          ...
          <template #formContent2 >
             <!-- Banco Consignacion -->
            <div class="col-span-6 sm:col-span-4" >
              <jet-label for="Banco C" value="Banco A Consignar" class="font-serif text-xl" />
              <hr />
            </div>
            <br>
            ...
            <div class="col-span-6 sm:col-span-4 md:flex">
              <!-- Nit -->
              <div class="md:w-2/5">
                <jet-label for="id" value="Numero de cuenta" />
                <jet-input
                  id="Ncuenta"
                  type="number"
                  class="block w-full mt-1"
              ...
              separator="."
               ...
               v-model="CreateTransferForm.monto">
                ...
                <jet-input-error :message="CreateTransferForm.errors.name" class="mt-2" />
              </div>
            </div>
              <br />
              <br />
              <!-- maximo a solicitar -->
              <div class="col-span-6 sm:col-span-4 md:flex" v-for="solicitud in solicitudes.data" :key="solicitud.id">
                      <div class="mt-3 md:mt-0 md:ml-2 md:w-3/5"  >
                        El Maximo a consignar es de :
                <!-- permite el cambio de color en el valor positivo o negativo  -->
                     <span v-if="solicitud.monto > 0" class="inline-flex px-1 text-xs font-semibold leading-5 text-green-900 bg-green-200 rounded-full"

                       >   {{ "$ " + formatMiles(solicitud.monto) }}. </span>

                         <span v-if="solicitud.monto < 0" class="inline-flex px-1 text-xs font-semibold leading-5 text-red-900 bg-red-200 rounded-full"

                       >   {{ "$ " + formatMiles(solicitud.monto) }}. </span>
                      </div>
                           <div class="mt-3 md:mt-0 md:ml-2 md:w-3/5">
                      </div>
            <!-- Boton solicitar consignacion a banco -->
            <div class="mt-3 md:mt-0 md:ml-9 md:w-1/5">
             <jet-button >
              Solicitar
            </jet-button>
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                <tr v-for="solicitud in solicitudes.data" :key="solicitud.id">
                  <td class="px-3 py-2 whitespace-nowrap">
                    <div class="text-sm tracking-widest text-center text-gray-900">
                      {{ solicitud.id }}
                    </div>
                  </td>

                  <td class="px-3 py-2 whitespace-nowrap">
                    <div class="text-sm tracking-widest text-gray-900 oldstyle-nums">
                  ...
                  <td class="px-3 py-2 whitespace-nowrap">
                    <div class="text-base tracking-widest text-gray-900 oldstyle-nums">
