            ...
            <div class="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
                ...
                <form class="flex flex-col pt-3 md:pt-8" @submit.prevent="submit">
                    <div class="flex flex-col pt-4">
                        ...
                        <jet-input readonly v-model="form.email" type="email" id="email" placeholder="su@email.com" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mt-1 leading-tight focus:outline-none focus:shadow-outline"/>
                    </div>
                    ...
                    <div class="flex flex-col pt-4">
                        <jet-label for="password" class="text-lg" value="Confirmar Contraeña"/>
                        <jet-input v-model="form.password_confirmation" type="password" id="password" placeholder="Confirmar contraseña" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mt-1 leading-tight focus:outline-none focus:shadow-outline"/>
                    </div>                    
    
                    <jet-button type="submit" value="Guardar contraseña" class="flex-auto bg-black text-white font-bold text-sm text-center hover:bg-gray-700 p-4 mt-6">Guardar contraseña</jet-button>
                </form>
