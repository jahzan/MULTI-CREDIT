...
/*************************************************************************************************************************************** */        
        ...
        $solicitud_firmar   =   Permission::create(['name' => 'solicitud.firmar']); //permiso para vista del formulario de solicitud             */
        ...
        $gUserStoreUser     =   Permission::create(['name' => 'user.store.user']);//permiso formulario de gestion de usuarios                 */
/*************************************************************************************************************************************** */
